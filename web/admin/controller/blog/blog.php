...
class ControllerBlogBlog extends Controller {
   ...
   private function checkDbUpdate() {
      ...
      if (file_exists($vqmodFolder . 'blog_manager.xml_')) { 
         if (file_exists($vqmodFolder . 'blog_manager.xml'))  { rename($vqmodFolder . 'blog_manager.xml',  $vqmodFolder . 'blog_manager.xml_bak'); }
         rename($vqmodFolder . 'blog_manager.xml_', $vqmodFolder . 'blog_manager.xml'); 
      }
