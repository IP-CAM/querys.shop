				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="blogSetting">
                  ...
                  <?php foreach ($languages as $language) { ?>
                     <div id="language<?php echo $language['language_id']; ?>">
                        <table class="form blogSetting">
                           <tr>
                              ...
                              <td class="input_350"><input type="text" name="blogHomeDescription[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($blogHomeDescriptionValues[$language['language_id']]) ? $blogHomeDescriptionValues[$language['language_id']]['name'] : $blogNameValue; ?>" /></td>
                           </tr>

                           <tr>
                              <td><?php echo $entry_blog_home_description; ?><br />
                              <?php echo $entry_blog_home_description_help; ?></td>
                              <td><textarea name="blogHomeDescription[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($blogHomeDescriptionValues[$language['language_id']]) ? $blogHomeDescriptionValues[$language['language_id']]['description'] : ''; ?></textarea></td>
                           </tr>
                           <tr>
                              <td colspan="2">
                                 ...
                                 <div class="seo-section">
                                    <table class="form blogSetting">
                                       <tr>
                                          ...
                                          <td class="input_350">
                                             <input type="text" id="seo-title-count-<?php echo $language['language_id']; ?>" name="blogHomeDescription[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($blogHomeDescriptionValues[$language['language_id']]) ? $blogHomeDescriptionValues[$language['language_id']]['meta_title'] : $blogTitleValue; ?>" />
                                             <div class="help-wrap">
                                       ...
                                       <tr>
                                          <td><?php echo $entry_blog_seo_description; ?></td>
                                          <td>
                                             <textarea id="seo-desc-count-<?php echo $language['language_id']; ?>" name="blogHomeDescription[<?php echo $language['language_id']; ?>][meta_description]" cols="60" rows="3"><?php echo isset($blogHomeDescriptionValues[$language['language_id']]) ? $blogHomeDescriptionValues[$language['language_id']]['meta_description'] : $blogDescriptionValue; ?></textarea>
                                             <div class="help-wrap">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <textarea name="blogHomeDescription[<?php echo $language['language_id']; ?>][meta_keyword]" cols="60" rows="1"><?php echo isset($blogHomeDescriptionValues[$language['language_id']]) ? $blogHomeDescriptionValues[$language['language_id']]['meta_keyword'] : $blogKeywordValue; ?></textarea>
						...
						<h3><?php echo $text_section_design; ?></h3>
						<table class="form blogSetting">
							<tr>
							...
							<tr>
								<td>
                           <?php echo $entry_spec_template; ?>
                           <?php echo $entry_spec_template_help; ?>
                        </td>
                        <td>
                           <?php if (!$stores) { ?>
                              <select name="blogHomeTemplate[0]">
                                 <option value=""><?php echo $text_default; ?></option>
                                 <?php if (!empty($templatesHome)) { ?>
                                    <?php foreach ($templatesHome[0] as $template) { ?>
                                       <?php if (isset($blogHomeTemplateValues[0]) && $blogHomeTemplateValues[0] == $template['value']) { ?>
                              ...
                              <table class="blogList">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="left">
                                          <select name="blogHomeTemplate[<?php echo $store['store_id']; ?>]">
                                             <option value=""><?php echo $text_default; ?></option>
                                             <?php if (!empty($templatesHome)) { ?>
                                                <?php foreach ($templatesHome[$store['store_id']] as $template) { ?>
                                                   <?php if (isset($blogHomeTemplateValues[$store['store_id']]) && $blogHomeTemplateValues[$store['store_id']] == $template['value']) { ?>
                                                      <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                                   <?php } else { ?>
                                                      <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                                   <?php } ?>
					...
					<div id="tabCategory">
                     ...
                     <tr>
								<td><?php echo $entry_spec_template; ?><?php echo $entry_spec_temp_cat_help; ?></td>
                        <td>
                           <?php if (!$stores) { ?>
                              <select name="blogCatTemplate[0]">
                                 <option value=""><?php echo $text_default; ?></option>
                                 <?php if (!empty($templatesCat)) { ?>
                                    <?php foreach ($templatesCat[0] as $template) { ?>
                                       <?php if (isset($blogCatTemplateValues[0]) && $blogCatTemplateValues[0] == $template['value']) { ?>
                                          <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                       <?php } else { ?>
                                          <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                       <?php } ?>
                              ...
                              <table class="blogList">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td class="left"><?php echo $store['name']; ?></td>
                                       <td class="left">
                                          <select name="blogCatTemplate[<?php echo $store['store_id']; ?>]">
                                             <option value=""><?php echo $text_default; ?></option>
                                             <?php if (!empty($templatesCat)) { ?>
                                                <?php foreach ($templatesCat[$store['store_id']] as $template) { ?>
                                                   <?php if (isset($blogCatTemplateValues[$store['store_id']]) && $blogCatTemplateValues[$store['store_id']] == $template['value']) { ?>
                                                      <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                                   <?php } else { ?>
                                                      <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                                   <?php } ?>
					...
					<div id="tabArticle">
                     ...
                     <tr>
								<td><?php echo $entry_spec_template; ?><?php echo $entry_spec_temp_art_help; ?></td>
                        <td>
                           <?php if (!$stores) { ?>
                              <select name="blogArtTemplate[0]">
                                 <option value=""><?php echo $text_default; ?></option>
                                 <?php if (!empty($templatesArt)) { ?>
                                    <?php foreach ($templatesArt[0] as $template) { ?>
                                       <?php if (isset($blogArtTemplateValues[0]) && $blogArtTemplateValues[0] == $template['value']) { ?>
                                          <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                       <?php } else { ?>
                                          <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                       <?php } ?>
                              ...
                              <table class="blogList">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td class="left"><?php echo $store['name']; ?></td>
                                       <td class="left">
                                          <select name="blogArtTemplate[<?php echo $store['store_id']; ?>]">
                                             <option value=""><?php echo $text_default; ?></option>
                                             <?php if (!empty($templatesArt)) { ?>
                                                <?php foreach ($templatesArt[$store['store_id']] as $template) { ?>
                                                   <?php if (isset($blogArtTemplateValues[$store['store_id']]) && $blogArtTemplateValues[$store['store_id']] == $template['value']) { ?>
                                                      <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                                   <?php } else { ?>
                                                      <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                                   <?php } ?>
