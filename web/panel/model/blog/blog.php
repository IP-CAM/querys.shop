...
class ModelBlogBlog extends Model {
	public function install() {
		$this->db->query("CREATE TABLE `" . DB_PREFIX . "blog_article` ( `article_id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY, `author_id` int(11) NOT NULL DEFAULT '0', `image` varchar(255) COLLATE utf8_bin DEFAULT NULL, `sort_order` int(11) NOT NULL DEFAULT '0', `comment` int(11) NOT NULL DEFAULT '2', `status` int(11) NOT NULL DEFAULT '0', `available` date NOT NULL, `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `viewed` int(11) NOT NULL DEFAULT '0' ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1;");
