...
$_['entry_password']     = 'Payment Response password:<br /><span class="help-block">This has to be set in the WordPay control panel</span>';
$_['entry_callback']     = 'Relay Response URL:<br /><span class="help-block">This has to be set in the WordPay control panel. You will also need to check the "Enable the Shopper Response"</span>';
