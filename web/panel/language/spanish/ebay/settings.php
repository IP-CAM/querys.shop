<?php
$_['lang_heading_title']        = 'OpenBay Pro para eBay | Configuracion';
...
$_['lang_load']                 = 'Cargar';
$_['lang_text_success']         = 'Tu Configuraciones han sido guardado';

$_['lang_error_save_settings']  = 'Necesitas guardar tu Configuraciones primero';

$_['lang_tab_token']            = 'Detalles de API'; 
$_['lang_tab_general']          = 'Configuracion'; 
$_['lang_tab_setup']            = 'Configuracion'; 
$_['lang_tab_defaults']         = 'Listado defaults'; 
$_['lang_tab_shipping']         = 'Envio defaults';

$_['lang_legend_api']           = 'Detalles de conexion API';
$_['lang_legend_app_settings']  = 'Configuraciones de Aplicacion';
$_['lang_legend_default_import']= 'Configuraciones Importar default';
$_['lang_legend_payments']      = 'Pagos';
$_['lang_legend_returns']       = 'Devoluciones';
$_['lang_legend_linkup']        = 'Enlazar Articulos';
$_['lang_legend_usage']         = 'Uso de Llamadas';
$_['lang_legend_subscription']  = 'Subscripcion';

$_['lang_error_oc_version']     = 'Tu version of OpenCart <u>no es</u> soportada';

$_['lang_status']               = 'Estado';
$_['lang_enabled']              = 'Habilitado';
$_['lang_disabled']             = 'Deshabilitado';
$_['lang_obp_token']            = 'Token';
$_['lang_obp_token_register']   = 'Presionar aqui registrate para tu token';
$_['lang_obp_token_renew']      = 'Presionar aqui para renovar tu token';
$_['lang_obp_secret']           = 'Secreta';
...
$_['lang_import_pending']       = 'Importar Ordenes sin pagar:';
$_['lang_import_def_id']        = 'Importar Estado default:';
$_['lang_import_paid_id']       = 'Estado pagado:';
$_['lang_import_shipped_id']    = 'Estado Enviado:';
$_['lang_import_cancelled_id']  = 'Estado Cancelado:';
$_['lang_import_refund_id']     = 'Estado Reembolsado:';
$_['lang_import_part_refund_id']= 'Estado parcialmente Reembolsado:';

$_['lang_developer']            = 'Desarrollador';
$_['lang_developer_desc']       = 'No debes usar esta area al menos que se te indique que lo hagas'; 
$_['lang_developer_empty']      = 'Vaciar todos los Datos?'; 
$_['lang_setting_desc']         = 'Configuraciones default son usadas para fijar las Opcions de un Listado de eBay. Todos los defaults pueden ser cambiados en la Pagina de Listado de cada Articulo';
$_['lang_payment_instruction']  = 'Instrucciones de Pago';
$_['lang_payment_paypal']       = 'PayPal aceptado';
$_['lang_payment_paypal_add']   = 'Email PayPal';
$_['lang_payment_cheque']       = 'Cheque aceptado';
$_['lang_payment_card']         = 'Tarjeta aceptada';
...
$_['lang_api_ok']                   = 'Conexion OK, token expira';
$_['lang_api_failed']               = 'Fallo Validacion';
$_['lang_api_connect_fail']         = 'Falla al conectar';
$_['lang_api_connect_error']        = 'Error al conectar';

$_['lang_create_date']              = 'Creo fecha para nuevas Ordenes';
$_['lang_create_date_0']            = 'Cuando sea agregado a OpenCart';
$_['lang_create_date_1']            = 'Cuando es creado en eBay';
