				...
				<table class="blogList commentList">
					<thead>
						<tr>
							...
							<td class="center" style="width:135px;"><?php echo $text_status; ?></td>
						...
						<?php if ($comments) { ?>
							...
							<?php foreach ($comments as $comment) { ?>
								...
								<tr id="comment-row<?php echo $comment['comment_id']; ?>" class="<?php echo $class . $badge . $disabled; ?>">
									...
									<td class="left">
										<b><a href="<?php echo $comment['filter_name']; ?>"><?php echo $comment['name']; ?></a></b><br/>
										<div class="blogMeta">
											<a href="<?php echo $comment['filter_email']; ?>"><?php echo $comment['email']; ?></a><br/>
