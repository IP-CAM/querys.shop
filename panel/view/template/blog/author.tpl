			...
			<div id="tabAuthors">
				...
				<table class="blogAuthor">
					<tr>
								...
								<table class="blogList">
									<thead>
										<tr>
											...
											<td class="article center"><?php echo $text_author_articles; ?></td>
										...
										<tr>
											...
											<?php foreach ($authors as $author) { ?>
												...
												<tr class="<?php echo $class; ?>">
													...
													<td><?php
                                          if ($author['oc_user_id']) {
                                             echo $author['name'];
                                          } else {
                                             echo '<span class="red">' . $author['name'] . '</span>';
                                          }
                                       ?></td>
													<td class="center"><?php echo $author['total_article']; ?></td>
                                          ...
                                          <?php 
                                             if ($author['oc_user_id']) {
                                                ...
                                                echo $text_user_notavail; $show_note = 1;
                                             }
                                          ?>
                                       </td>
												</tr>
                        ...
                        <?php if (isset($show_note)) { echo $text_user_notavail_help; } ?>
							</form>
						</td>
						<?php } ?>
                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="changeAuthor">
                           <table class="blogList">
                              <thead>
                                 <tr>
                                    <td colspan="2"><?php echo $text_author_change; ?></td>
                                 </tr>
                              </thead>
                              <tbody>
                                 <tr class="select_175">
                                    <td><?php echo $text_author_change_from; ?></td>
                                    <td>
                                       <select name="from_author_id" onchange="authorChange(this);">
                                          <option value=""></option>
                                          <?php foreach ($authors as $author) { ?>
                                             <option value="<?php echo $author['author_id']; ?>"><?php echo $author['name']; ?></option>
                                          <?php } ?>
                                 ...
                                 <tr class="select_175">
                                    <td><?php echo $text_author_change_to; ?></td>
                                    <td class="input_165">
                                       <select name="changeAuthor" id="to_author_id">
                                          <option value=""></option>
                                          <?php foreach ($authors as $author) { ?>
                                             <option value="<?php echo $author['author_id']; ?>"><?php echo $author['name']; ?></option>
                                          <?php } ?>
                        ...
                        <div class="buttons right">
                           <a onclick="$('#changeAuthor').submit();" class="button"><?php echo $button_submit; ?></a>
                        </div>
							<?php } ?>
						</td>
						<?php } ?>
...
function authorChange(author_id) {
   //$("#to_author_id option[value='" + author_id.value + "']").remove();
   mysel = document.getElementById('to_author_id');
   mysel.selectedIndex = 0;

   $("#to_author_id option").removeClass('hide');
   $("#to_author_id option[value='" + author_id.value + "']").addClass('hide');
