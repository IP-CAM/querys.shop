			...
			<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-delete">
				<table class="blogList">
					<thead>
						<tr>
							...
							<?php if ($sort == 'ad.title') { ?>
								<td class="center <?php echo strtolower($order); ?>" style="width:135px;"><a href="<?php echo $sort_title; ?>"><?php echo $column_title; ?></a></td>
							<?php } else { ?>
								<td class="center"><a href="<?php echo $sort_title; ?>"><?php echo $column_title; ?></a></td>
							<?php } ?>
							<td class="center" style="width:125px;"><?php echo $column_seo; ?></td>
							<?php if ($sort == 'a.created') { ?>
								<td class="center <?php echo strtolower($order); ?>" style="width:90px;"><a href="<?php echo $sort_created; ?>"><?php echo $column_created; ?></a></td>
							<?php } else { ?>
								<td class="center" style="width:90px;"><a href="<?php echo $sort_created; ?>"><?php echo $column_created; ?></a></td>
							<?php } ?>
							<td class="center">
                     ...
                     <td class="center" style="width:85px;">
                        <?php if ($sort == 'a2s.store_id') { ?>
							...
							<td class="center" style="width:85px;"><?php echo $column_status; ?></td>
							<td class="center <?php echo ($sort == 'a.sort_order') ? strtolower($order) : ''; ?>" style="width:45px;"><a href="<?php echo $sort_sort_order; ?>"><?php echo $column_sort_order; ?></a></td>
					...
					<tbody>					
                           ...
                           <td class="left">
                              ...
                              <?php if (!empty($stores)) { ?>
                                 <?php foreach ($stores as $store1) { ?>
                                    <?php if (in_array($store1['store_id'], $article['store'])) { ?>
						...
						<?php } else { ?>
							<tr>
								<?php if ((isset($haspermission_copyArticle) || isset($haspermission_removeArticle)) && (isset($haspermission_editOwnArticle) || isset($haspermission_editOtherArticle))) { ?>
