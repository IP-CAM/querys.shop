...
$_['entry_callback']     = 'Alert URL:<br /><span class="help-block">This has to be set in the Payza control panel. You will also need to check the "IPN Status" to enabled.</span>';
