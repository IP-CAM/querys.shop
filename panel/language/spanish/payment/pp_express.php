...
$_['text_ipn']                          = 'IPN url<span class="help-block">Required for subscriptions</span>';
...
$_['entry_currency']                    = 'Default currency<span class="help-block">Used for transaction searches</span>';
...
$_['entry_logo']                        = 'Logo<span class="help-block">Max 750px(w) x 90px(h)<br />You should only use a logo if you have SSL set up.</span>';
$_['entry_border_colour']               = 'Header border colour:<span class="help-block">6 character HTML colour code</span>';
$_['entry_header_colour']               = 'Header background colour:<span class="help-block">6 character HTML colour code</span>';
$_['entry_page_colour']                 = 'Page background colour:<span class="help-block">6 character HTML colour code</span>';
