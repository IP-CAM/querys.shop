...
// Entry
$_['entry_merchant']      = 'Klarna Merchant ID:<br /><span class="help-block">(estore id) to use for the Klarna service (provided by Klarna).</span>';
$_['entry_secret']        = 'Klarna Secret:<br /><span class="help-block">Shared secret to use with the Klarna service (provided by Klarna).</span>';
