      ...
      <div id="et-content">
               ...
               <div id="language<?php echo $language['language_id']; ?>" class="<?php echo $language['code']; ?>">
                  <table class="form">
                     <tr>
                        ...
                        <td class="input_350">
                           <input type="text" class="keyword-generate" name="article_description[<?php echo $language['language_id']; ?>][title]" size="100" value="<?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['title'] : ''; ?>" />
                              ...
                              <div class="seo-section">
                                 <table class="form">
                                    <tr>
                                       ...
                                       <td class="input_350">
                                          <input type="text" id="seo-title-count-<?php echo $language['language_id']; ?>" name="article_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['meta_title'] : ''; ?>" />
                                          <div class="help-wrap">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <textarea id="seo-desc-count-<?php echo $language['language_id']; ?>" name="article_description[<?php echo $language['language_id']; ?>][meta_description]" cols="60" rows="3"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                          <div class="help-wrap">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <textarea name="article_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="60" rows="1"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
         ...
         <div id="tabData" class="vtabs-content">
            <table class="form">
               ...
               <tr>
                  ...
                  <td class="select_90">
                     <select name="comment">                      
                        <option value="2" <?php if ($comment == '2' || $comment == '') { echo 'selected="selected"'; } ?>><?php echo $text_default; ?></option>
                        <option value="1" <?php if ($comment == '1') { echo 'selected="selected"'; } ?>><?php echo $text_enabled; ?></option>
                        <option value="0" <?php if ($comment == '0') { echo 'selected="selected"'; } ?>><?php echo $text_disabled; ?></option>
                     </select>
                     <?php echo $entry_comment_help; ?>
                  </td>
               </tr>
               <tr>
         ...
         <div id="tabDesign" class="vtabs-content">
            <table class="list">
               <thead>
                  <tr>
                     <td class="left" style="width:225px;"><?php echo $entry_store; ?></td>
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="left">
                        <select name="article_template[0][template]">
                           <option value=""><?php echo $text_inherit; ?></option>
                           <?php if (!empty($templates)) { ?>
                              <?php foreach ($templates[0] as $template) { ?>
                                 <?php if (isset($article_template[0]) && $article_template[0] == $template['value']) { ?>
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="left">
                        <select name="article_template[<?php echo $store['store_id']; ?>][template]">
                           <option value=""><?php echo $text_inherit; ?></option>
                           <?php if (!empty($templates)) { ?>
                              <?php foreach ($templates[$store['store_id']] as $template) { ?>
                                 <?php if (isset($article_template[$store['store_id']]) && $article_template[$store['store_id']] == $template['value']) { ?>
                                    <option value="<?php echo $template['value']; ?>" selected="selected"><?php echo $template['name']; ?></option>
                                 <?php } else { ?>
                                    <option value="<?php echo $template['value']; ?>"><?php echo $template['name']; ?></option>
                                 <?php } ?>
